...
当前版本：**0.9.4**（2026-08-22）  
仓库：https://github.com/nonomil/blocklegend  
协议：[AGPL-3.0](LICENSE)

## 这版有什么

- 营地出生点旁停着会动的紫金龙；先白骑 20 秒，买龙鞍后才能在指定关继续骑
- 营地更大：5 个广场、13 座能走进去的房子，石边土路通向传送门
- 屋子里有木地板、床、箱子、桌子、椅子、火把；东边有湖和码头，南边有河
- 按 V 能看见「听你说 / 说中 / 听到了什么」；跳、砍、游、吃、骑会闪出英文
- 进关有一句中英剧情，3 秒或按键跳过，世界不停
