# CliproxAPI gpt-image-2 · blocklegend roster four-views
...
def generate(name: str, prompt: str, size: str = "1024x1024") -> Path:
    ...
    try:
        ...
        print("HTTP", err.code, "cf-ray", ray, file=sys.stderr)
...
def main() -> None:
    load_env(ENV_FILE)
    names = sys.argv[1:] or ["golem"]
    for name in names:
        prompt_path = PROMPTS / (name + "-4view.txt")
