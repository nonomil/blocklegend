...
(function (global) {
    ...
    function createSpiderModel(THREE, options) {
        if (global.BlockLegendFourView && global.BlockLegendAtlas4V && global.BlockLegendAtlas4V.spider) {
            const fv = global.BlockLegendFourView.build(THREE, 'spider', Object.assign({
